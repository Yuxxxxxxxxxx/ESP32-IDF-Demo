...
static spp_receive_data_buff_t spp_recv_data_buff = {
    .node_num   = 0,
    .buff_size  = 0,
    .first_node = NULL
};
...
static const esp_gatts_attr_db_t spp_gatt_db[SPP_IDX_NB] =
{
    ...
    [SPP_IDX_SVC] = ATTR_DESC(ESP_GATT_AUTO_RSP, primary_service_uuid, ESP_GATT_PERM_READ,
                sizeof(spp_service_uuid), sizeof(spp_service_uuid), &spp_service_uuid),

    // SPP -  data receive characteristic Declaration
    [SPP_IDX_SPP_DATA_RECV_CHAR] = ATTR_DESC(ESP_GATT_AUTO_RSP, character_declaration_uuid, ESP_GATT_PERM_READ,
                                CHAR_DECLARATION_SIZE,CHAR_DECLARATION_SIZE, &char_prop_read_write),

    // SPP -  data receive characteristic Value
    [SPP_IDX_SPP_DATA_RECV_VAL] = ATTR_DESC(ESP_GATT_AUTO_RSP, spp_data_receive_uuid, ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE,
                                SPP_DATA_MAX_LEN,sizeof(spp_data_receive_val), spp_data_receive_val),

    // SPP -  data notify characteristic Declaration
    [SPP_IDX_SPP_DATA_NOTIFY_CHAR] = ATTR_DESC(ESP_GATT_AUTO_RSP, character_declaration_uuid, ESP_GATT_PERM_READ,
                                   CHAR_DECLARATION_SIZE, CHAR_DECLARATION_SIZE, &char_prop_read_notify),

    // SPP -  data notify characteristic Value
    [SPP_IDX_SPP_DATA_NTY_VAL] = ATTR_DESC(ESP_GATT_AUTO_RSP, spp_data_notify_uuid, ESP_GATT_PERM_READ,
                               SPP_DATA_MAX_LEN, sizeof(spp_data_notify_val), spp_data_notify_val),

    // SPP -  data notify characteristic - Client Characteristic Configuration Descriptor
    [SPP_IDX_SPP_DATA_NTF_CFG] = ATTR_DESC(ESP_GATT_AUTO_RSP, character_client_config_uuid, ESP_GATT_PERM_READ|ESP_GATT_PERM_WRITE,
                               sizeof(uint16_t), sizeof(spp_data_notify_ccc), spp_data_notify_ccc),

    // SPP -  command characteristic Declaration
    [SPP_IDX_SPP_COMMAND_CHAR] = ATTR_DESC(ESP_GATT_AUTO_RSP, character_declaration_uuid, ESP_GATT_PERM_READ,
                               CHAR_DECLARATION_SIZE, CHAR_DECLARATION_SIZE, &char_prop_read_write),

    // SPP -  command characteristic Value
    [SPP_IDX_SPP_COMMAND_VAL] = ATTR_DESC(ESP_GATT_AUTO_RSP, spp_command_uuid, ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE,
                              SPP_CMD_MAX_LEN, sizeof(spp_command_val), spp_command_val), 

    // SPP -  status characteristic Declaration
    [SPP_IDX_SPP_STATUS_CHAR] = ATTR_DESC(ESP_GATT_AUTO_RSP, character_declaration_uuid, ESP_GATT_PERM_READ,
                              CHAR_DECLARATION_SIZE, CHAR_DECLARATION_SIZE, &char_prop_read_notify),

    // SPP -  status characteristic Value
    [SPP_IDX_SPP_STATUS_VAL] = ATTR_DESC(ESP_GATT_AUTO_RSP, spp_status_uuid, ESP_GATT_PERM_READ,
                            SPP_STATUS_MAX_LEN, sizeof(spp_status_val), spp_status_val),

    // SPP -  status characteristic - Client Characteristic Configuration Descriptor
    [SPP_IDX_SPP_STATUS_CFG] = ATTR_DESC(ESP_GATT_AUTO_RSP, character_client_config_uuid, ESP_GATT_PERM_READ|ESP_GATT_PERM_WRITE,
                             sizeof(uint16_t), sizeof(spp_status_ccc), spp_status_ccc),
...
{
    temp_spp_recv_data_node_p1 = spp_recv_data_buff.first_node;
    ...
    spp_recv_data_buff.node_num = 0;
    spp_recv_data_buff.buff_size = 0;
    spp_recv_data_buff.first_node = NULL;
}
...
static bool store_wr_buffer(esp_ble_gatts_cb_param_t *p_data)
{
    ...
    spp_recv_data_buff.buff_size += p_data->write.len;
    ...
    if(spp_recv_data_buff.node_num == 0){
        spp_recv_data_buff.first_node = temp_spp_recv_data_node_p1;
        spp_recv_data_buff.node_num++;
    } else{
        spp_recv_data_buff.node_num++;
    }
